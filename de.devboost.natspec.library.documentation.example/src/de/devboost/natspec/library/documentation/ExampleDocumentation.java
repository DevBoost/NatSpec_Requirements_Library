...
public class ExampleDocumentation {
	...
	public void saveDocumentation() throws Exception {
		...
		// 
		de.devboost.natspec.library.documentation.Line line_ = documentationSupport.createPlainContents(java.util.Arrays.asList(new String[] {""}), section_Meta_Data__);
		// Subsection - Authors
		...
		// 
		de.devboost.natspec.library.documentation.Line line_0 = documentationSupport.createPlainContents(java.util.Arrays.asList(new String[] {""}), subsection_Authors);
		// |---- --------------------------------------------------------------------------------- ----|
		...
		// 
		de.devboost.natspec.library.documentation.Line line_1 = documentationSupport.createPlainContents(java.util.Arrays.asList(new String[] {""}), subsection_Revisions);
		// |---- ---------------------------------------------------------------------- ----|
		...
		// 
		de.devboost.natspec.library.documentation.Line line_2 = documentationSupport.createPlainContents(java.util.Arrays.asList(new String[] {""}), section_Introduction_and_Goals);
		// Paragraph
		...
		// 
		de.devboost.natspec.library.documentation.Line line_3 = documentationSupport.createPlainContents(java.util.Arrays.asList(new String[] {""}), subsection_Objectives);
		...
		// 
		de.devboost.natspec.library.documentation.Line line_4 = documentationSupport.createPlainContents(java.util.Arrays.asList(new String[] {""}), subsection_Stakeholders);
		// Section - Constraints
		...
		// 
		de.devboost.natspec.library.documentation.Line line_5 = documentationSupport.createPlainContents(java.util.Arrays.asList(new String[] {""}), section_Constraints);
		...
		// 
		de.devboost.natspec.library.documentation.Line line_6 = documentationSupport.createPlainContents(java.util.Arrays.asList(new String[] {""}), subsection_Architecture_Constraints);
		...
		// 
		de.devboost.natspec.library.documentation.Line line_7 = documentationSupport.createPlainContents(java.util.Arrays.asList(new String[] {""}), subsection_Architecture_Constraints);
		...
		// 
		de.devboost.natspec.library.documentation.Line line_8 = documentationSupport.createPlainContents(java.util.Arrays.asList(new String[] {""}), subsection_Technical_Constraints);
		...
		// 
		de.devboost.natspec.library.documentation.Line line_9 = documentationSupport.createPlainContents(java.util.Arrays.asList(new String[] {""}), subsection_Organizational_Constraints);
		...
		// 
		de.devboost.natspec.library.documentation.Line line_10 = documentationSupport.createPlainContents(java.util.Arrays.asList(new String[] {""}), subsection_Organizational_Constraints);
		...
		// 
		de.devboost.natspec.library.documentation.Line line_11 = documentationSupport.createPlainContents(java.util.Arrays.asList(new String[] {""}), subsection_Conventions);
		...
		// 
		de.devboost.natspec.library.documentation.Line line_12 = documentationSupport.createPlainContents(java.util.Arrays.asList(new String[] {""}), subsection_Conventions);
		...
		// 
		de.devboost.natspec.library.documentation.Line line_13 = documentationSupport.createPlainContents(java.util.Arrays.asList(new String[] {""}), section_System_Scope_and_Context);
		// 
		de.devboost.natspec.library.documentation.Line line_14 = documentationSupport.createPlainContents(java.util.Arrays.asList(new String[] {""}), section_System_Scope_and_Context);
		...
		// 
		de.devboost.natspec.library.documentation.Line line_15 = documentationSupport.createPlainContents(java.util.Arrays.asList(new String[] {""}), subsection_Technical_Context);
		...
		// 
		de.devboost.natspec.library.documentation.Line line_16 = documentationSupport.createPlainContents(java.util.Arrays.asList(new String[] {""}), subsection_Technical_Context);
		...
		// 
		de.devboost.natspec.library.documentation.Line line_17 = documentationSupport.createPlainContents(java.util.Arrays.asList(new String[] {""}), subsection_External_Interfaces);
		...
		// 
		de.devboost.natspec.library.documentation.Line line_18 = documentationSupport.createPlainContents(java.util.Arrays.asList(new String[] {""}), subsection_External_Interfaces);
		...
		// 
		de.devboost.natspec.library.documentation.Line line_19 = documentationSupport.createPlainContents(java.util.Arrays.asList(new String[] {""}), section_Solution_Strategy);
		...
		// 
		de.devboost.natspec.library.documentation.Line line_20 = documentationSupport.createPlainContents(java.util.Arrays.asList(new String[] {""}), section_Solution_Strategy);
		...
		// 
		de.devboost.natspec.library.documentation.Line line_21 = documentationSupport.createPlainContents(java.util.Arrays.asList(new String[] {""}), section_Components_View);
		// System components
		...
		// 
		de.devboost.natspec.library.documentation.Line line_22 = documentationSupport.createPlainContents(java.util.Arrays.asList(new String[] {""}), section_Components_View);
		...
		// 
		de.devboost.natspec.library.documentation.Line line_23 = documentationSupport.createPlainContents(java.util.Arrays.asList(new String[] {""}), subsection_Components_Overview);
		...
		// 
		de.devboost.natspec.library.documentation.Line line_24 = documentationSupport.createPlainContents(java.util.Arrays.asList(new String[] {""}), subsection_Components_Overview);
		...
		// 
		de.devboost.natspec.library.documentation.Line line_25 = documentationSupport.createPlainContents(java.util.Arrays.asList(new String[] {""}), subsection_Component_One_Details_View);
		...
		// 
		de.devboost.natspec.library.documentation.Line line_26 = documentationSupport.createPlainContents(java.util.Arrays.asList(new String[] {""}), subsection_Component_One_Details_View);
		...
		// 
		de.devboost.natspec.library.documentation.Line line_27 = documentationSupport.createPlainContents(java.util.Arrays.asList(new String[] {""}), subsection_Component_Two_Details_View);
		// Zoom into next level
		...
		// 
		de.devboost.natspec.library.documentation.Line line_28 = documentationSupport.createPlainContents(java.util.Arrays.asList(new String[] {""}), subsection_Component_Two_Details_View);
		...
		// 
		de.devboost.natspec.library.documentation.Line line_29 = documentationSupport.createPlainContents(java.util.Arrays.asList(new String[] {""}), subsection_Refine_hierarchy_as_needed___);
		...
		// 
		de.devboost.natspec.library.documentation.Line line_30 = documentationSupport.createPlainContents(java.util.Arrays.asList(new String[] {""}), section_Domain_Models);
		...
		// 
		de.devboost.natspec.library.documentation.Line line_31 = documentationSupport.createPlainContents(java.util.Arrays.asList(new String[] {""}), section_Domain_Models);
		...
		// 
		de.devboost.natspec.library.documentation.Line line_32 = documentationSupport.createPlainContents(java.util.Arrays.asList(new String[] {""}), subsection_User_Interface);
		...
		// 
		de.devboost.natspec.library.documentation.Line line_33 = documentationSupport.createPlainContents(java.util.Arrays.asList(new String[] {""}), subsection_User_Interface);
		...
		// 
		de.devboost.natspec.library.documentation.Line line_34 = documentationSupport.createPlainContents(java.util.Arrays.asList(new String[] {""}), subsection_Use_Cases___Scenarios);
		...
		// 
		de.devboost.natspec.library.documentation.Line line_35 = documentationSupport.createPlainContents(java.util.Arrays.asList(new String[] {""}), subsection_Use_Cases___Scenarios);
		...
		// 
		de.devboost.natspec.library.documentation.Line line_36 = documentationSupport.createPlainContents(java.util.Arrays.asList(new String[] {""}), subsection_Use_Cases___Scenarios);
		...
		// 
		de.devboost.natspec.library.documentation.Line line_37 = documentationSupport.createPlainContents(java.util.Arrays.asList(new String[] {""}), subsection_Decision_Rules);
		...
		// 
		de.devboost.natspec.library.documentation.Line line_38 = documentationSupport.createPlainContents(java.util.Arrays.asList(new String[] {""}), subsection_Decision_Rules);
		...
		// 
		de.devboost.natspec.library.documentation.Line line_39 = documentationSupport.createPlainContents(java.util.Arrays.asList(new String[] {""}), subsection_Validation_Rules);
		...
		// 
		de.devboost.natspec.library.documentation.Line line_40 = documentationSupport.createPlainContents(java.util.Arrays.asList(new String[] {""}), subsection_Validation_Rules);
		...
		// 
		de.devboost.natspec.library.documentation.Line line_41 = documentationSupport.createPlainContents(java.util.Arrays.asList(new String[] {""}), subsection_Error_Handling_Rules);
		...
		// 
		de.devboost.natspec.library.documentation.Line line_42 = documentationSupport.createPlainContents(java.util.Arrays.asList(new String[] {""}), section_Cross_Cutting_Requirements);
		...
		// 
		de.devboost.natspec.library.documentation.Line line_43 = documentationSupport.createPlainContents(java.util.Arrays.asList(new String[] {""}), section_Cross_Cutting_Requirements);
		...
		// 
		de.devboost.natspec.library.documentation.Line line_44 = documentationSupport.createPlainContents(java.util.Arrays.asList(new String[] {""}), subsection_Usability);
		...
		// 
		de.devboost.natspec.library.documentation.Line line_45 = documentationSupport.createPlainContents(java.util.Arrays.asList(new String[] {""}), subsection_Accessibility_);
		...
		// 
		de.devboost.natspec.library.documentation.Line line_46 = documentationSupport.createPlainContents(java.util.Arrays.asList(new String[] {""}), subsection_Reliability);
		...
		// 
		de.devboost.natspec.library.documentation.Line line_47 = documentationSupport.createPlainContents(java.util.Arrays.asList(new String[] {""}), subsection_Responsibility);
		// Subsection - Security	
		...
		// 
		de.devboost.natspec.library.documentation.Line line_48 = documentationSupport.createPlainContents(java.util.Arrays.asList(new String[] {""}), subsection_Security_);
		...
		// 
		de.devboost.natspec.library.documentation.Line line_49 = documentationSupport.createPlainContents(java.util.Arrays.asList(new String[] {""}), subsection_Persistence_);
		// Section - Risks
		...
		// 
		de.devboost.natspec.library.documentation.Line line_50 = documentationSupport.createPlainContents(java.util.Arrays.asList(new String[] {""}), section_Risks);
		// Section - Glossary
